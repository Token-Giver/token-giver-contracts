...
use tokengiver::interfaces::ICampaignPool::{ICampaignPoolDispatcher, ICampaignPoolDispatcherTrait};
use tokengiver::campaign_pool::CampaignPools::{Event, ApplicationMade};
...
fn create_test_campaign_pool(pool_contract_address: ContractAddress) -> ContractAddress {
    ...
    let campaign_pool_dispatcher = ICampaignPoolDispatcher {
        contract_address: pool_contract_address
    };

    start_cheat_caller_address(
        pool_contract_address, starknet::contract_address_const::<'ADMIN'>()
    );
    ...
    let campaign_pool_address = campaign_pool_dispatcher
